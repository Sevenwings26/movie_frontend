...
// const [movies, setMovies] = useState<Movie[]>([]);
    ...
    try {
      ...
      setMovies(
        data.items.map((movie: any): Movie => ({
          id: movie.id,
          title: movie.title,
          genre: movie.genre,
          release_year: movie.release_year,
          description: movie.description ?? "", // ✅ becomes string
          ratings_count: movie.ratings_count ?? 0, // ✅ becomes number
          ratings_avg: movie.ratings_avg ?? 0,
          created_by_username: movie.created_by_username ?? "Unknown",
